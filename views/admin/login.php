...
<head>
    ...
    <script src="<?= url("/assets/admin/js/login.js") ?>" async></script>
</head>
<body>
    <div class="container">
        <div class="login-container">
            ...
            <form id="loginForm">
                ...
                <div class="link-reset">
                    <a href="/Dona-Angela-Store-/admin/redefinir-senha">Esqueci minha senha</a>
                </div>
            </form>
            <div class="link-register">
                Não tem uma conta? <a href="/Dona-Angela-Store-/admin/cadastro">Cadastre-se</a>
            </div>
        </div>
