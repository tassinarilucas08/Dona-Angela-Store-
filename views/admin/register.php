...
<head>
    ...
    <link rel="stylesheet" href="<?= url("/assets/admin/css/register.css") ?>">
  <script src="<?= url("/assets/admin/js/register.js") ?>" async></script>
</head>
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="link-login">
                Já tem uma conta? <a href="/Dona-Angela-Store-/admin/login">Faça login</a>
            </div>
        </div>
    </div>
</body>
