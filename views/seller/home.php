...
<head>
  ...
  <link rel="stylesheet" href="<?= url("/assets/seller/css/home.css") ?>">
  <script src="<?= url("/assets/seller/js/home.js") ?>" async></script>
...
<body>
  ...
  <header>
    ...
    <a href="/Dona-Angela-Store-/seller/login" class="login-link">Login</a>

    <a href="/Dona-Angela-Store-/seller/perfil" class="perfil-link">
      <img src="https://img.icons8.com/ios-filled/50/000000/user-male-circle.png" alt="Perfil do Usuário" class="perfil-icon">
    </a>

    <div class="cart-icon">
      <a href="/Dona-Angela-Store-/seller/carrinho"><img src="/Dona-Angela-Store-/images/layout/sacola.png" alt="Sacola de Compras"></a>
...
<a href="/Dona-Angela-Store-/seller/produto"><div class="product-card todos feminino perfumes">
  ...
  <div class="product-info">
    ...
    <div class="vendedor-actions">
      <a href="/Dona-Angela-Store-/seller/vendedor" class="action-button">+ Criar Produto</a>
    </div>
  </main>
</body>
</html>