...
<head>
  ...
  <script src="<?= url("/assets/web/js/home.js") ?>" async></script>
...
<body>
  ...
  <header>
    ...
    <div class="cart-icon">
      <a href="/Dona-Angela-Store-/carrinho"><img src="/Dona-Angela-Store-/images/layout/sacola.png" alt="Sacola de Compras"></a>
